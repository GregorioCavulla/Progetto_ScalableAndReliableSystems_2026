...
L'architettura è basata su \texttt{Kind} (Kubernetes IN Docker), che avvia cluster Kubernetes locali in container Docker, replicando scheduler, networking e controller di un cluster reale in un ambiente facilmente ricreabile per validazione e test.
