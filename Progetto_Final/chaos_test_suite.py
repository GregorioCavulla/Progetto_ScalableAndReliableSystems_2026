...
def test_load_spike(apps_api):
    ...
    logging.info("Injecting massive load using client_simulator.py...")
    drones_before = 0
    drones_after = 0
    namespace = "default"
    ...
    try:
        ...
        logging.info("Executing client_simulator.py to generate 50 requests...")
        process = subprocess.Popen(["python3", "client_simulator.py", "--stress"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        
        logging.info("Allowing 15 seconds for Logistic AI Brain to detect queue spike and scale drone deployment...")
        time.sleep(15)
